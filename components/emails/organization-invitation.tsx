					...
					<Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[40px] shadow-sm">
						...
						<Section className="mb-[32px]">
							...
							<Text className="m-0 mb-[16px] text-[16px] text-gray-700">
								...
								<strong>{props.teamName}</strong> on our
								platform.
							</Text>
							<Text className="m-0 mb-[24px] text-[16px] text-gray-700">
								Accept this invitation to start collaborating
								with your team members and access all the tools
								and resources available in your organization.
							</Text>
						</Section>
						...
						<Section className="mb-[32px]">
							<Text className="m-0 mb-[8px] text-[14px] text-gray-600">
								...
								also copy and paste this link into your browser:
							</Text>
						...
						<Section className="border-gray-200 border-t pt-[24px]">
							<Text className="m-0 mb-[8px] text-center text-[12px] text-gray-500">
								This invitation was sent to {props.email}. If
								you weren&apos;t expecting this invitation, you
